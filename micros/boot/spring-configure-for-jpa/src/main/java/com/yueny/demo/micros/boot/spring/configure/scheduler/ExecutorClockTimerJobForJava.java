package com.yueny.demo.micros.boot.spring.configure.scheduler;
...
@Slf4j
@Service
public class ExecutorClockTimerJobForJava {
	...
	public void doSomething() {
		executor.scheduleWithFixedDelay(() -> {
			try {
				...
				log.error("【ExecutorClockTimerJobForJava】 超过超时，下次继续.");
			}
		}, 0, /* N second */2 * 1000L, TimeUnit.MILLISECONDS);
	}
	...
	private void processData(final String batchId) {
		...
		log.info("ExecutorClockTimerJobForJava : {} 总耗时:{}秒.", batchId, (end - start) / 1000);
	}
