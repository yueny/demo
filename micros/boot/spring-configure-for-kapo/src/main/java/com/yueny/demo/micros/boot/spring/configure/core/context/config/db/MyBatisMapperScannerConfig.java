...
public class MyBatisMapperScannerConfig {
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		try {
			final Class<?> superClass = Class.forName("com.yueny.kapo.api.biz.ISqlMapper");
			mapperScannerConfigurer.setMarkerInterface(superClass);
		} catch (final ClassNotFoundException e) {
			e.printStackTrace();
		}

		// 只加载实现了 ISqlMapper 的 mapper.java
		mapperScannerConfigurer.setBasePackage(
				"com.yueny.kapo.core;com.yueny.demo.common.example.dao;com.yueny.demo.micros.boot.spring.configure.dao.mapper;");
