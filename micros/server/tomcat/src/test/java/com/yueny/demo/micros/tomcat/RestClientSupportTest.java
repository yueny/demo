package com.yueny.demo.micros.tomcat;
...
public class RestClientSupportTest {
	...
	private static final String serviceUrl = "http://localhost:8092/micros_tomcat";
	...
	public void send() {
		...
		try {
			...
			// {
			// });
			final NormalResponse<JobForMatcherRequest> resp = client.postForObject("/post/data", req,
