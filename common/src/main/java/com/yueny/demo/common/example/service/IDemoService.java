...
public interface IDemoService {
	 ...
	 * @return 新增成功条数
	 */
	int insertList(final List<DemoBo> ds);
	 ...
	 * 根据类型查询数据
	 */
	List<DemoBo> queryByType(YesNoType type);
	 ...
	 * @return 是否成功
	 */
	boolean update(final DemoBo tobeUpdate);
}
