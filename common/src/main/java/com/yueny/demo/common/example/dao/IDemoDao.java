 ...
 *
 */
public interface IDemoDao extends IOriginDao<DemoEntry>, IWholeTableQueryDao<DemoEntry>, IClearTableDao,
		IDeleteTableDao, IMultipleTableDao<DemoEntry> {
	/**
	 * 根据分片项查询未处理的数据主键<br>
	 ...
	 * 根据类型查询数据
	 */
	List<DemoEntry> queryByType(YesNoType type);
